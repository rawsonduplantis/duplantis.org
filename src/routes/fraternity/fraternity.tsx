...
export default function Fraternity() {
    ...
    return (<>
        ...
        <div className="h-full w-full pt-16 bg-orange-100/75 flex items-center justify-center flex-col">
            <div className="m-4">
                <p className="flex w-full justify-center font-serif font-semibold text-orange-950/75 text-2xl">Third Generation (Fall '91 - Present)</p>
